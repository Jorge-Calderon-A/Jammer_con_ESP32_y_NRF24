...
En este contexto se aplica un bloqueador de señales, lo que hace este dispositivo es emitir señales que sean similares a la que un receptor recibe, de tal manera que este se confunda y no logre distinguir cual es la correcta.
...
Los modulos NRF24l01 son bastante sensibles en su aplicación, la intensidad de corriente generara una temperatura interna alta, usted percibira que el modulo estara caliente, es completamente normal. Se recomienda modulos de alta calidad como los **Ebyte** para una alta distancia de interferencia.
